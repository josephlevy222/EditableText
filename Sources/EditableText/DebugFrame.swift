...
private struct DebugFrame: ViewModifier {
	...
	private func defineOutput(with geometry: GeometryProxy) -> String {
		...
		let originX: String = "x: \(roundedToHundredths(globalOrigin.x))"
		let originY: String = "y: \(roundedToHundredths(globalOrigin.y))"
		let width: String = "w: \(roundedToHundredths(geometry.size.width))"
		let height: String = "h: \(roundedToHundredths(geometry.size.height))"
	...
	private func roundedToHundredths(_ value: CGFloat) -> Float {
